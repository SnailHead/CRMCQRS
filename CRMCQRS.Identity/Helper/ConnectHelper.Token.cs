...
namespace CRMCQRS.Identity.Helper;
...
public static partial class ConnectHelper
{
    ...
    public static async Task<IResult> ConnectPasswordGrantType(HttpContext httpContext, OpenIddictRequest? request,
        UserManager<User> userManager,
        SignInManager<User> signInManager,
    ...
    public static async Task<AuthenticationProperties?> CheckUser(User user, OpenIddictRequest? request, UserManager<User> userManager, SignInManager<User> signInManager)
    {
        if (user == null)
        {
    ...
    public static async Task<ClaimsPrincipal> CreatePasswordClaimsPrincipal(OpenIddictRequest? request, IAccountService accountService, User user, IOpenIddictScopeManager scopeManager)
    {
